                ...
                <Container>
                    <Row>
                        ...
                        <div style={{ height: '400px', width: '100%', display: "flex", justifyContent: 'center' }}>
                            <PollutionRadarChart data={data} selectedState={selectedState} handlePollutionTypeChange={handlePollutionTypeChange} />
                        </div>
                    </Row>
                    <hr className="solid" />
                    <Row>
                        <div style={{ display: 'flex', alignItems: 'center', }}>
                            ...
                            <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                                ...
                                <DropdownMenu style={{ width: '180px' }}>
                                    <DropdownItem onClick={() => handleSelect('polyethylene')}>polyethylene</DropdownItem>
                                    <DropdownItem onClick={() => handleSelect('polypropylene')}>polypropylene</DropdownItem>
                                    <DropdownItem onClick={() => handleSelect('polyethylene glycol')}>polyethylene glycol</DropdownItem>
                                    <DropdownItem onClick={() => handleSelect('polystyrene')}>polystyrene</DropdownItem>
                                    <DropdownItem onClick={() => handleSelect('thermoset')}>thermoset</DropdownItem>
                                    <DropdownItem onClick={() => handleSelect('thermoplastic')}>thermoplastic</DropdownItem>
                                    <DropdownItem onClick={() => handleSelect('other')}>other</DropdownItem>
                                </DropdownMenu>
                            </Dropdown>
                        </div>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Card className="pollution-card" variant="outlined" style={{ width: '95%', margin: "0 auto" }}>
                            <CardContent>
                                <Row>
                                    <h4>Potential Products & Alternatives</h4>
                                </Row>
                                                ...
                                                <Card style={{ margin: 5, height: 110 }}>
                                                    <CardContent sx={{
                                                        ...
                                                        <Grid container justifyContent="center" alignItems="center">
                                                            <img width="25px" height="25px" src={source[0].img} alt={source[0].alt} />
                                                        </Grid>
                                                        <Typography variant="h6" align="center" sx={{ marginTop: '16px' }}>
                                                            {source[0].name}
                                                        </Typography>
                                                    </CardContent>
                                                </Card>
                                            ...
                                            <Col md={5}>
                                                <Card style={{ margin: 5, height: 110 }}>
                                                    <CardContent sx={{
                                                        ...
                                                        <Grid container justifyContent="center" alignItems="center">
                                                            <img width="25px" height="25px" src={source[1].img} alt={source[1].alt} />
                                                        </Grid>
                                                        <Typography variant="h6" align="center" sx={{ marginTop: '16px' }}>
                                                            {source[1].name}
                                                        </Typography>
                    ...
                    {pollutionSuggestion.other.length > 0 &&
                        <Row>
                            ...
                            <Row className="justify-content-start" style={{ overflowX: 'auto', whiteSpace: 'nowrap' }}>
                                    ...
                                    <Col key={index} md={3}>
                                        <Card style={{ margin: 5 }}>
                                            <CardContent sx={{
                                                ...
                                                <Grid container justifyContent="center" alignItems="center">
                                                    <img width="25px" height="25px" src={source.img} alt={source.alt} />
                                                </Grid>
                                                <Typography variant="h6" align="center" sx={{ marginTop: '16px' }}>
                                                    {source.name}
                                                </Typography>
