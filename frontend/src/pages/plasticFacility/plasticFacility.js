...
function PlasticFacility() {
    ...
    function success(position) {
        ...
        axios
            .get(
                `https://api.mapbox.com/search/geocode/v6/reverse?longitude=${longitude}&latitude=${latitude}&access_token=pk.eyJ1IjoieWluZzAzMDIiLCJhIjoiY2xtazZ6ZGhzMGE3bzJpcnBxeDBpdWtxOSJ9.yqzTjBA_A6g5arWp4H2ZBA`
            )
            .then((res) => {
                setUserState(
    ...
    useEffect(() => {
        ...
        mapboxgl.accessToken =
            "pk.eyJ1IjoieWluZzAzMDIiLCJhIjoiY2xtazZ6ZGhzMGE3bzJpcnBxeDBpdWtxOSJ9.yqzTjBA_A6g5arWp4H2ZBA";
    ...
    useEffect(() => {
        ...
        const selectedFacility = distanceFacilities.filter(
    ...
    useEffect(() => {
        ...
        const foundFacility = stateFacility.filter(
            (item) => item.suburb.toLowerCase() === inputSuburb.toLowerCase()
        );
                        ...
                        <Col md="12" sm={{ size: "auto" }}>
                            ...
                            >
                                <h2 style={{ paddingTop: "5px" }}>
                                    Discover Nearby Plastic Recycling Facilities
                                </h2>
                                <h4 style={{ color: "#3f4447" }}>
                                    Locate facilities in your area that accept plastic waste.
                                    Access detailed information including location and contact
                                    details to help you recycle and repurpose your materials.
                                </h4>
                            </div>
                        </Col>
                    </Row>
